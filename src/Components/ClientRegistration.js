  ...
  return (
    <>
      ...
      <FormStyled onSubmit={handleSubmit(onSubmit)}>
        ...
        <Input
          placeholder='Street'
          {...register('street', { required: true })}></Input>
        <Input
          placeholder='Flat Number'
          {...register('flatnumber', { required: true })}></Input>
        <Input
          placeholder='Post Code'
          {...register('postcode', { required: true })}></Input>
        <Input
          placeholder='City'
          {...register('city', { required: true })}></Input>
        <Input
          placeholder='Country'
          {...register('country', { required: true })}></Input>
        <Input
          type='password'
        ...
        <StyledLink to='/' style={{ marginBottom: '2rem' }}>
          Log in
        </StyledLink>
      </FormStyled>
    </>
