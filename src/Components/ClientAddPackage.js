...
function ClientAddPackage(props) {
  ...
  const onSubmit = (data) => {
    ...
    buttonRef.current.style.backgroundColor = colors.lightYellow;
    ...
    fetch(`${variables.endpoint}/api/user/client-errands`, options).then(
      (result) => {
        ...
        buttonRef.current.value = "Add";
        buttonRef.current.style.backgroundColor = colors.darkBlue;
  ...
  return (
    <>
      ...
      <FormStyled onSubmit={handleSubmit(onSubmit)}>
        ...
        ></Input>
        <Button ref={buttonRef} type="submit" value="Add"></Button>
      </FormStyled>
    </>
  );
}
